                ...
                if(count($getData)>0){
                    foreach($getData as $val){
                        ...
                        <tr id="<?php echo $val->id; ?>">
                            ...
                            <td><div class="input-group"><input type="text" id="copyTarget_<?php echo $val->id; ?>" value="<?php echo $code; ?>"><span class="input-group-btn"><button class="button action" data-clipboard-action="copy" data-clipboard-target="#copyTarget_<?php echo $val->id; ?>" id="copyButton" type="button">Copy</button></span></div></td>
                            <td>
                                <input type="checkbox" name="ajaxStatus" id="ajaxStatus<?php echo $val->id; ?>" <?php if($val->ajaxStatus==1){echo 'checked="checked"';} ?> value="1" />
                            </td>
                            <td>
                                ...
                                <select name="windowTarget" id="windowTarget<?php echo $val->id; ?>">
                                    ...
                                    <option value="_self" <?php if($val->windowTarget=="_self"){echo 'selected="selected"';} ?>>Self</option>
                                    <option value="_blank" <?php if($val->windowTarget=="_blank"){echo 'selected="selected"';} ?> >Blank</option>
                                </select>
                            </td>
